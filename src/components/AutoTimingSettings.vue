...
<template>
  <div class="space-y-2">
    <span v-if="checked && ready" class="app-chip bg-success/15 text-success">引擎就绪 · {{ version }}</span>
    <span v-else-if="checked" class="app-chip bg-error/15 text-error">{{ errorMsg || '引擎未安装' }}</span>
